...
DIM I AS BYTE
DIM J AS BYTE
DIM Y AS BYTE 'Yellow'
DIM B AS BYTE 'Blue'
DIM R AS BYTE 'Red'
DIM G AS BYTE 'Green'
DIM RO AS BYTE 'Red OUT'
DIM BO AS BYTE 'Blue OUT'
DIM MODE AS BYTE
DIM A AS BYTE
DIM A_old AS BYTE
DIM C AS BYTE
...
적외선거리센서확인:
    ...
    IF 적외선거리값>  60 THEN '50 = 적외선거리값 = 25cm''현승'
        MUSIC "C"
        'GOSUB 문열기_1'
        거리측정 = 0
        DELAY 200
...
브릿지:
    ...
    MOVE G6A,101, 146,  30, 115, 100, 100
    MOVE G6B, 10,  25,  80, 100, 100, 100
    MOVE G6C, 10,  25,  80, 100, 122, 100
    MOVE G6D,100, 145,  30, 115, 100, 100
    WAIT

    MOVE G6A,100,  10, 120, 120, 100, 100
    MOVE G6D,100,  10, 120, 120, 100, 100
    MOVE G6B, 35,  70,  15, 100, 100,  99
    MOVE G6C, 35,  70,  15, 100, 125,
    WAIT
...
브릿지_LOOP:
    ...
    MOVE G6A,100,  10, 113, 120, 100, 100
    MOVE G6D,100,  10, 115, 120, 100, 100
    MOVE G6B, 50,  70,  15, 100, 100,  99
    MOVE G6C, 50,  70,  15, 100, 125,

    WAIT
    MOVE G6A,100,  10, 120, 120, 100, 100
    MOVE G6D,100,  10, 120, 120, 100, 100
    MOVE G6B, 20,  70,  15, 100, 100,  99
    MOVE G6C, 20,  70,  15, 100, 125,
...
거미자세:
    ...
    MOVE G6A,100, 145,  28, 145, 100, 100
    MOVE G6D,100, 145,  28, 145, 100, 100
    MOVE G6C,180, 127, 150,
    MOVE G6B,180, 127, 150,
    WAIT
    mode = 1

    GOSUB Leg_motor_mode3
    SPEED 12
    MOVE G6A,102, 120,  68,  31, 100, 100
    MOVE G6D,100, 116,  68,  31, 100, 100
    MOVE G6C,180, 127, 150,
    MOVE G6B,180, 127, 150,
    WAIT
    ...
    SPEED 52
    MOVE G6A,105,  55,  97,  75,  100, 100
    MOVE G6D,105,  55,  97,  75,  100, 100
    MOVE G6B, 180,  125,  146,
    MOVE G6C, 180,  125,  146,
    WAIT

    SPEED 52
    MOVE G6A,100,  94,  64,  59, 125, 100
    MOVE G6D,100,  94,  64,  59, 125, 100
    MOVE G6C,180, 127, 150,
    MOVE G6B,180, 127, 150,
    WAIT	
...
거미자세_LOOP:
    ...
    WAIT
    A=8
    IF A = 8 THEN GOTO 거미자세_1

    GOTO 거미자세일어나기

거미자세_1:

    MOVE G6D,100,  11, 151,  59, 125, 100
    MOVE G6A,100,  94,  64,  59, 125, 100
    MOVE G6C,180, 127, 150,
    MOVE G6B,180, 127, 150,
    WAIT
    A=7
    IF A = 7 THEN GOTO 거미자세_2
...
거미자세_2:
    ...
    MOVE G6A,100,  94,  64,  59, 125, 100
    MOVE G6D,100,  94,  64,  59, 125, 100
    MOVE G6B, 152,  125,  153,
    MOVE G6C,180, 127, 150,
    WAIT
    A=6
    IF A = 6 THEN GOTO 거미자세_3

    GOTO 거미자세일어나기

거미자세_3:

    MOVE G6A,100,  11, 151,  59, 125, 100
    MOVE G6D,100,  94,  64,  59, 125, 100
    MOVE G6B, 180, 127, 150,
    MOVE G6C, 152,  125,  153,
    WAIT
    A=5
    IF A = 5 THEN GOTO 거미자세_4
...
'노란선따라이동:
 '   MUSIC "C"
  ...
  '  IF   Y>150 OR Y=150 THEN '''143:라인 중심맞추기(라인이 오른쪽에 있을 때)
   '     MOVE G6C,100,  ,  ,  ,  31   '서원
    '    GOSUB 오른쪽옆으로20


    'ELSEIF Y<100 OR Y=100 THEN '''144:라인 중심맞추기(라인이 왼쪽에 있을 때)
     '   MOVE G6C,100,  ,  ,  ,  31   '서원
      '  GOSUB 왼쪽옆으로20
...
노란선기울기확인:
        ...
        IF A>104 AND A<108 THEN'''145: 로봇이 왼쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 오른쪽턴20

        ELSEIF A>89 AND A<96 THEN'''146: 로봇이 오른쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 왼쪽턴20
        ELSEIF A>96 AND A<100 THEN'''145: 로봇이 왼쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 왼쪽턴45
        ELSEIF A=96 THEN'''145: 로봇이 왼쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 왼쪽턴45

        ELSEIF A>100 AND A<104  THEN'''146: 로봇이 오른쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 오른쪽턴45
        ELSEIF A=104  THEN'''146: 로봇이 오른쪽으로 기울어지게 있음
            MOVE G6C,100,  ,  ,  ,  31   '서원
            GOSUB 오른쪽턴45
        ELSE  '''142:라인따라 직전
            MOVE G6C,100,  ,  ,  ,  31  '서원
...
구역확인_YES:
    ...
    IF A=0 THEN
        GOTO 우유확인tx
    ENDIF
    IF B>40 OR 찬우유<1 THEN
        GOTO 우유확인tx
    ENDIF
    ETX 4800,61''' 61:우유장애물빠져나감
    MOVE G6C,100,  ,  ,  ,  31
    GOSUB 오른쪽턴60
    GOSUB 오른쪽턴45
    GOSUB 오른쪽턴45
...
문열기:
    ...
    MOVE G6B,101,  59, 109, 100, 100,  13
    MOVE G6C,187,  53,  10, 100,  95, 100
    WAIT
    ...
    MOVE G6C, 98,  33,  83, 100,  50, 100
    MOVE G6B,105,  31,  82, 100, 100, 103
    WAIT
...
셔터:
    ...
    MOVE G6A,100, 145,  28, 145, 100, 100
    MOVE G6D,100, 145,  28, 145, 100, 100
    MOVE G6B, 13, 186, 117, 100,  49, 100
    MOVE G6C, 13, 186, 117, 100,  49, 100
    WAIT

    MOVE G6A,100,  76, 145,  93, 100, 100
    MOVE G6D,100,  76, 145,  93, 100, 100
    MOVE G6B, 86, 188, 117, 100, 100,  96
    MOVE G6C, 86, 188, 117, 100, 100,  96
    WAIT
...
셔터2:
    ...
    MOVE G6A,100,  76, 145,  93, 100, 100
    MOVE G6D,100,  76, 145,  93, 100, 100
    MOVE G6B,189,  31,  81, 100, 100,  97
    MOVE G6C,189,  31,  81, 100, 100,  97
    WAIT
