...
void Standard() {
  ...
  if (MotionNumber<40) {
    if ((Firstarmth>-105&&Firstarmth<-60)&&(Secondarmth>-115&&Secondarmth<-65)&&(FirstarmthL>-125&&FirstarmthL<-75)&&(SecondarmthL>-115&&SecondarmthL<-65)&&(FirstKnee>-100&&FirstKnee<-60)&&(SecondKnee>-110&&SecondKnee<-70)&&(FirstKneeL>-120&&FirstKneeL<-80)&&(SecondKneeL>-110&&SecondKneeL<-70)) {
      ...
      println("차렷! 탐색중....("+MotionNumber+"/40)");
      if (Kind == 1) {
        image(StandardW, 0, 0, width, height);
      } else if (Kind == 2) {
        image(StandardL, 0, 0, width, height);
...
void HandsUp() {
  ...
  if (MotionNumber<25) {
    if ((Firstarmth>40&&Firstarmth<110)&&(Secondarmth>45&&Secondarmth<110)&&(FirstarmthL>50&&FirstarmthL<130)&&(SecondarmthL>50&&SecondarmthL<130)) {
      ...
      println("손들기 탐색중....("+MotionNumber+"/25)");
      image(HandsUp, 0, 0, width, height);
      if ((CheckingNumber>=10&&MotionNumber==0)||(CheckingNumber>=5&&MotionNumber>0)) {
...
void InfraspinatusR() {
  counter();
  if (MotionNumber<45) {
    if ((Firstarmth>-80&&Firstarmth<-30)&&(Secondarmth>-160&&Secondarmth<-80)&&(FirstarmthL>-150&&FirstarmthL<-80)&&(SecondarmthL>-120&&SecondarmthL<-80)&&(FirstKnee>-100&&FirstKnee<-60)&&(SecondKnee>-110&&SecondKnee<-70)&&(FirstKneeL>-120&&FirstKneeL<-80)&&(SecondKneeL>-110&&SecondKneeL<-70)) {
...
void InfraspinatusL() {
  counter();
  if (MotionNumber<45) {
    if ((Firstarmth>-80&&Firstarmth<-40)&&(Secondarmth>-80&&Secondarmth<-40)&&(FirstarmthL>-150&&FirstarmthL<-110)&&(SecondarmthL>-80&&SecondarmthL<-40)) {
      println("Infraspintus3!");
      if (Kind2==0) {
